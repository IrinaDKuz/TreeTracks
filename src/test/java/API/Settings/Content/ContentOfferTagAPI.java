...
/***
 ...
 во вкладке Settings - "Tag Offer"
 */

public class ContentOfferTagAPI {
    ...
    private static JsonObject initializeJsonSettingTagBody(ContentTag contentTag) {
        ...
        tagObject.addProperty("name", contentTag.getTagTitle());
        titleObject.add("tag", tagObject);
        return titleObject;
    }
    ...
    public static ContentTag tagAddEdit(String method) {
        ...
        response = RestAssured.given()
                ...
                .post("https://api.admin.3tracks.link/setting/tag/" + method);
    ...
    public static ArrayList<ContentTag> tagGet() {
        ...
        JSONArray dataArray = dataObject.getJSONArray("tags");
